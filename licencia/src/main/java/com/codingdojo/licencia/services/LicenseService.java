...
import com.codingdojo.licencia.repositories.LicenseRepository;
...
public class LicenseService {
	...
	public static int getLicenseNumber() {
	 ...
	 // Método estatico para establecer un nuevo valor para el número de licencia
	public static void setLicenseNumber(int licenseNumber) {
		LicenseService.licenseNumber = licenseNumber;
	}
	
	 // convertir un numero entero en una cadena con el formato 000001
